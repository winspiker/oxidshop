                ...
                <div class="col-xs-12 col-sm-6 col-md-[{$iColIdent}] productBox">
                    <div class="picture text-center">
                        <a href="[{$_product->getMainLink()}]" title="[{$sBargainArtTitle|strip_tags}]" class="img-thumbnail">
                            ...
                            <img src="[{$_product->getThumbnailUrl()}]" alt="[{ $_product->getTabslImageTag($_product->oxarticles__tabsl_imagetag1->value) }]" title="[{ $_product->getTabslImageTag($_product->oxarticles__tabsl_imagetag1->value) }]" class="img-responsive">
