 ...
 * Class oetagsTagController
 */
class oetagsTagController extends \AList
{
    /**
     * List type
     *
    ...
    protected function _addPageNrParam($sUrl, $iPage, $iLang = null)
    {
        ...
        if ($blSeo && ($sTag = $this->getTag())) {
            if ($iPage && ($sSeoUrl = oxRegistry::get("oetagsSeoEncoderTag")->getTagPageUrl($sTag, $iPage, $iLang))) {
    ...
    public function getCanonicalUrl()
    {
        if (($iPage = $this->getActPage())) {
            ...
            return oxRegistry::get("oetagsSeoEncoderTag")->getTagUrl($sTag);
        }
        return '';
    }
    ...
    public function getBreadCrumb()
    {
        ...
        $aCatPath['link'] = oxRegistry::get("oxSeoEncoder")->getStaticUrl($sSelfLink . 'cl=oetagstagscontroller');
        $aPaths[] = $aCatPath;
