            ...
            [{else}]
                ...
                <div id="orderEditCart">
                    <form action="[{$oViewConf->getSslSelfLink()}]" method="post">
                        ...
                        <div class="panel panel--order-cart">
                            <div class="panel-heading">
                                <h3 class="panel-title">
                ...
                [{else}]
                    [{block name="checkout_order_btn_confirm_bottom"}]
                        <form action="[{$oViewConf->getSslSelfLink()}]" method="post" id="orderConfirmAgbBottom" class="form-horizontal">
                            ...
                            <div class="well well-sm">
                                <button type="submit" class="btn btn-primary pull-right submitButton nextStep largeButton">
                    ...
                    [{*if $isPaypalpluscwModule}]
                        [{capture assign="sExonnPayPalScript"}]
                            (function($){$(function(){
                                $("#ppplus").parent().append(
                                    $("<div></div>").attr({
                                        "data-pp-message": true,
                                        "data-pp-style-layout": "text",
                                        "data-pp-style-logo-type": "inline",
                                        "data-pp-style-text-color": "black",
                                        "data-pp-amount": fbq_price,
                                    }).css({
                                        "padding-left": 15,
                                    })
                                );
                        ...
                        [{/capture}]
                        [{oxscript add=$sExonnPayPalScript}]
                    [{/if*}]
