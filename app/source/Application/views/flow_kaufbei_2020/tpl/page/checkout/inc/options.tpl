<div class="paypal-remove-wrapper">
...
<style>
    .paypal-remove-wrapper #amazonPayButtonLine {
         display: none;
     }

    .paypal-remove-wrapper .checkoutOptions + #amazonPayButtonLine {
        display: block;
    }
</style>