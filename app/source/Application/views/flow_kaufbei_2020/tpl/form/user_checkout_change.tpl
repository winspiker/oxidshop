...
[{block name="user_checkout_change"}]
    <form class="form-horizontal" action="[{$oViewConf->getSslSelfLink()}]" name="order" method="post" novalidate>
        [{block name="user_checkout_change_form"}]
            ...
            [{block name="user_checkout_change_next_step_top"}]
                <div class="well well-sm hidden-xs">
                    ...
                    <button id="userNextStepTop" class="btn btn-primary pull-right submitButton largeButton nextStep" name="userform" type="submit" onclick="ga('send', 'event', 'Button', 'Zum Zahlungsart');">[{oxmultilang ident="CONTINUE_TO_NEXT_STEP"}] <i class="fa fa-caret-right"></i></button>
                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                [{block name="user_checkout_billing_feedback"}]
                                    <div class="col-lg-9" id="addressText">
            ...
            [{block name="user_checkout_change_next_step_bottom"}]
                <div class="well well-sm">
                    ...
                    <button id="userNextStepBottom" class="btn btn-primary pull-right submitButton largeButton nextStep" name="userform" type="submit" onclick="ga('send', 'event', 'Button', 'Zum Zahlungsart');">[{oxmultilang ident="CONTINUE_TO_NEXT_STEP"}] <i class="fa fa-caret-right"></i></button>
                    <div class="clearfix"></div>
                </div>
            [{/block}]
        [{/block}]
