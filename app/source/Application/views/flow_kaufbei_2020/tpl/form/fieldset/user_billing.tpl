    ...
    <div class="col-lg-9">
        ...
        [{if !$blCountrySelected}]
            ...
            (!isset($invadr.oxuser__oxcountryid) && $oxcmp_user->oxuser__oxcountryid->value == $country->oxcountry__oxid->value)}]
                ...
                [{/if}]
            [{/if}]
            [{if $country->oxcountry__oxtitle->value == 'Deutschland'}]
...
<link rel="stylesheet" href="/modules/exonn_useraddress/exonn_useraddress.css">
<script type="text/javascript" src="/modules/exonn_useraddress/exonn_address.js"></script>
...
<div class="form-group[{if $aErrors.oxuser__oxzip}] text-danger[{/if}]">
    ...
    <div class="col-xs-5 col-lg-3">
        <input  id="zip_bill" onkeyup=" if (document.getElementById('invCountrySelect').value=='a7c40f631fc920687.20179984') searchData('zip_search_forcity_bill', 'zip_bill',  'city_select_bill', 'getAjaxQueryzipcity_bill', 'address')" class="form-control" type="text" maxlength="16" minlength="5" name="invadr[oxuser__oxzip]" value="[{if isset( $invadr.oxuser__oxzip )}][{$invadr.oxuser__oxzip}][{else}][{$oxcmp_user->oxuser__oxzip->value}][{/if}]"[{if $oView->isFieldRequired(oxuser__oxzip)}] required=""[{/if}]>
    </div>
    <div class="col-xs-7 col-lg-6 city_bill_container">
        <input  id="city_bill" class="form-control" type="text" maxlength="255" name="invadr[oxuser__oxcity]" value="[{if isset( $invadr.oxuser__oxcity )}][{$invadr.oxuser__oxcity}][{else}][{$oxcmp_user->oxuser__oxcity->value}][{/if}]"[{if $oView->isFieldRequired(oxuser__oxcity)}] required=""[{/if}]>
        <dt id="zip_search_forcity_bill" class="search_data" style="display: none;">
        </dt>
    </div>
...
<div class="form-group[{if $aErrors.oxuser__oxstreet}] text-danger[{/if}]">
    ...
    <div class="col-xs-8 col-lg-6">
        <input id="street_bill"    onkeyup=" if (document.getElementById('invCountrySelect').value=='a7c40f631fc920687.20179984') searchData('zip_search_bill', 'zip_bill',  'zip_select_bill', 'getAjaxQueryStreet_bill', 'address')" class="form-control" type="text" maxlength="255" name="invadr[oxuser__oxstreet]" value="[{if isset( $invadr.oxuser__oxstreet )}][{$invadr.oxuser__oxstreet}][{else}][{$oxcmp_user->oxuser__oxstreet->value}][{/if}]"[{if $oView->isFieldRequired(oxuser__oxstreet)}] required=""[{/if}]>
    </div>
    <div class="col-xs-4 col-lg-3">
        <input id="streetnr_bill" class="form-control" type="text" maxlength="16" name="invadr[oxuser__oxstreetnr]" value="[{if isset( $invadr.oxuser__oxstreetnr )}][{$invadr.oxuser__oxstreetnr}][{else}][{$oxcmp_user->oxuser__oxstreetnr->value}][{/if}]"[{if $oView->isFieldRequired(oxuser__oxstreetnr)}] required=""[{/if}]>
    </div>
...
<dt id="zip_search_bill" class="search_data" style="display: none">
</dt>
