 ...
 */
$aTheme = array(
    'id'          => 'flow-kaufbei-2020',
    'title'       => 'Flow Kaufbei 2020',
    ...
    'settings'    => array(
        ...
        array(
            'group' => 'footer',
            'name'  => 'sOdnoklassnikiUrl',
            'type'  => 'str',
            'value' => 'https://www.ok.ru',
        ),
        array(
            'group' => 'footer',
            'name'  => 'sInstagramUrl',
        ...
        array(
            'group'       => 'holiday',
            'name'        => 'blHolidaySelect',
            'type'        => 'select',
            'value'       => 'none',
            'constraints' => 'none|spring|newyear|winter|blackfriday',
        ),
    ),
);
