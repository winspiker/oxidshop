 ...
 */
    ...
    $this->dbName = 'd0301ad4'; // database name
    $this->dbUser = 'd0301ad4'; // database user name
    $this->dbPwd  = 'tDAFLZXMazGKsQH6'; // database user password
    $this->sShopURL     = 'https://www.kaufbei.tv'; // eShop base url, required
    $this->sSSLShopURL  = 'https://www.kaufbei.tv';            // eShop SSL url, optional
    $this->sAdminSSLURL = 'https://www.kaufbei.tv/admin';            // eShop Admin SSL url, optional
    $this->sShopDir     = '/www/htdocs/w00ea5c5/oxid6.kaufbei.tv/oxid_kaufbei/source';
    $this->sCompileDir  = '/www/htdocs/w00ea5c5/oxid6.kaufbei.tv/oxid_kaufbei/source/tmp';
