 ...
 */
    ...
    $this->dbName = 'd034123b'; // database name
    $this->dbUser = 'd034123b'; // database user name
    $this->dbPwd  = 'UomXrQ4rwCot46KG'; // database user password
    $this->sShopURL     = 'https://oxid6dev.kaufbei.tv'; // eShop base url, required
    $this->sSSLShopURL  = 'https://oxid6dev.kaufbei.tv';            // eShop SSL url, optional
    $this->sAdminSSLURL = 'https://oxid6dev.kaufbei.tv/admin';            // eShop Admin SSL url, optional
    $this->sShopDir     = '/www/htdocs/w00ea5c5/oxid6dev.kaufbei.tv/oxid_kaufbei/source';
    $this->sCompileDir  = '/www/htdocs/w00ea5c5/oxid6dev.kaufbei.tv/oxid_kaufbei/source/tmp';
