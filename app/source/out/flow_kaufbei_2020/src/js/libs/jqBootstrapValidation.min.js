        ...
        return this.each(function(){
          ...
          if (settings.options.sniffHtml) {
            ...
            if ($this.attr("minlength") !== undefined) {
              message = "Zu kurz: Mindestens '" + $this.attr("minlength") + "' Zeichen | wenn Ihre PLZ weniger als 5 Zeichen hat bitte eine 0 davor setzen<!-- data-validation-minlength-message to override -->";
