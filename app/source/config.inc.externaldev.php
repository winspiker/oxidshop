 ...
 */
    ...
    $this->dbName = 'd03411fd'; // database name
    $this->dbUser = 'd03411fd'; // database user name
    $this->dbPwd  = 'wo42Zuen32YZqPTJ'; // database user password
    $this->sShopURL     = 'https://oxid6externaldev.kaufbei.tv'; // eShop base url, required
    $this->sSSLShopURL  = 'https://oxid6externaldev.kaufbei.tv';            // eShop SSL url, optional
    $this->sAdminSSLURL = 'https://oxid6externaldev.kaufbei.tv/admin';            // eShop Admin SSL url, optional
    $this->sShopDir     = '/www/htdocs/w00ea5c5/oxid6externaldev.kaufbei.tv/oxid_kaufbei/source';
    $this->sCompileDir  = '/www/htdocs/w00ea5c5/oxid6externaldev.kaufbei.tv/oxid_kaufbei/source/tmp';
