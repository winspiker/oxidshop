...
<p class="desc">
    ...
    Die Fehlermeldung &quot;die Lizenz ist abgelaufen&quot; weist darauf hin, dass die Testlizenz f&uuml;r das [dg] Google Analytics Schnittstelle von draufgeschaut.de bereits in Ihrem Shop aktiviert wurde. <br /><br />
...
<div class="messagebox">
 <p>
   ...
   Erweiterungen > Module > [dg] Google Analytics Schnittstelle <br /><br />
   Vergessen Sie nicht eventuelle Cronjobs ebenfalls zu deaktivieren.<br />
   <br />
   Danke f&uuml;r Ihr Interresse an unseren Modul [dg] Google Analytics Schnittstelle.
 </p>
</div>
