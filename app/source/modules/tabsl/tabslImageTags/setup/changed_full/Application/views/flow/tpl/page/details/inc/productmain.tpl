                ...
                [{if $oView->showZoomPics()}]
                    ...
                    <div class="picture text-center">
                        <a href="[{$oPictureProduct->getMasterZoomPictureUrl(1)}]" id="zoom1"[{if $aPictureInfo}] data-width="[{$aPictureInfo.0}]" data-height="[{$aPictureInfo.1}]"[{/if}]>
                            ...
                            <img src="[{$oView->getActPicture()}]" alt="[{ $oPictureProduct->getTabslImageTag($oPictureProduct->oxarticles__tabsl_imagetag1->value) }]" title="[{ $oPictureProduct->getTabslImageTag($oPictureProduct->oxarticles__tabsl_imagetag1->value) }]" itemprop="image" class="img-responsive">
