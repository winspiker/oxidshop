...
class Client
{
    ...
    const URL_TYPE_GET_SUPPORTED_PROVIDER_TYPES = 'getSupportedPaymentTypes';
    ...
    protected function getRequestUrl($sType, $sOrderNr = false)
    {
        ...
        switch ($sType) {
            ...
            case self::URL_TYPE_SEND_ORDER_NR:
                ...
                break;
            case self::URL_TYPE_GET_SUPPORTED_PROVIDER_TYPES:
                $sUrl = $sBaseUrl.'fulfillment/providers?key='.$this->getToken();
                break;
    ...
    public function getSupportedProvidersTypes()
    {   
        $sUrl = $this->getRequestUrl(self::URL_TYPE_GET_SUPPORTED_PROVIDER_TYPES);
        $aProvidersTypes = $this->getJsonArrayFromRequest($sUrl);

        return $aProvidersTypes;
    }
