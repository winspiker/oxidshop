    ...
    initAoc = function()
    {
        ...
        YAHOO.oxid.container1 = new YAHOO.oxid.aoc( 'container1',
                                                    [ [{ foreach from=$oxajax.container1 item=aItem key=iKey }]
                                                      ...
                                                      [{ /foreach }] ],
                                                    '[{ $oViewConf->getAjaxLink() }]cmpid=container1&container=dgidealoactiv&synchoxid=[{ $oxid }]'
                                                    );
        ...
        YAHOO.oxid.container2 = new YAHOO.oxid.aoc( 'container2',
                                                    [ [{ foreach from=$oxajax.container2 item=aItem key=iKey }]
                                                      ...
                                                      [{assign var="sSep" value=","}]
                                                      [{ /foreach }] ],
                                                    '[{ $oViewConf->getAjaxLink() }]cmpid=container2&container=dgidealoactiv&oxid=[{ $oxid }]'
                                                    )
        ...
        YAHOO.oxid.container2.saveAttribute = function()
        {
            ...
            YAHOO.util.Connect.asyncRequest( 'GET', '[{ $oViewConf->getAjaxLink() }]&cmpid=container2&container=dgidealoactiv&fnc=dgSaveAmountValue&oxid=[{ $oxid }]&oxtype_value=' + encodeURIComponent( $('oxtype_value').value ) + '&oxamount_value=' + encodeURIComponent( $('oxamount_value').value ) + '&oxtype_oxid=' + encodeURIComponent( $('oxtype_oxid').value ), callback );
