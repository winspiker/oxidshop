...
<p class="desc">
    ...
    Die Fehlermeldung &quot;die Lizenz ist abgelaufen&quot; weist darauf hin, dass die Testlizenz f&uuml;r das Idealo Artikelexport und Bestellimport von draufgeschaut.de bereits in Ihrem Shop aktiviert wurde. <br /><br />
...
<div class="messagebox">
 <p>
   ...
   Erweiterungen > Module > Idealo Artikelexport und Bestellimport <br /><br />
   Vergessen Sie nicht eventuelle Cronjobs ebenfalls zu deaktivieren.<br />
   <br />
   Danke f&uuml;r Ihr Interresse an unseren Modul Idealo Artikelexport und Bestellimport.
 </p>
</div>
