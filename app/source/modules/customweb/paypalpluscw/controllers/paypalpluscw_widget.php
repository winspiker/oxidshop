...
class paypalpluscw_widget extends oxUBase
{
	protected $_sThisTemplate = 'paypalpluscw_widget.tpl';

	/**
	 * Display the widget page required by widget authorization method.
	 */
	public function render()
	{
		...
		try {
			...
			$vars = $adapter->getWidgetTemplateVars();
