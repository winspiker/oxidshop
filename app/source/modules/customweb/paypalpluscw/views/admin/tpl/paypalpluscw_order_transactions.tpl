					...
					<tbody>
						[{foreach from=$captures item=capture}]
							<tr class="border">
								...
								<td><a href="[{ $oViewConf->getSelfLink() }]cl=paypalpluscw_transaction_capture&oxid=[{$oxid}]&capture=[{$capture.id}]">View</a></td>
							</tr>
						[{/foreach}]
					</tbody>
				</table>
					...
					<tbody>
						[{foreach from=$refunds item=refund}]
							<tr class="border">
								...
								<td><a href="[{ $oViewConf->getSelfLink() }]cl=paypalpluscw_transaction_refund&oxid=[{$oxid}]&refund=[{$refund.id}]">View</a></td>
							</tr>
						[{/foreach}]
					</tbody>
				</table>
