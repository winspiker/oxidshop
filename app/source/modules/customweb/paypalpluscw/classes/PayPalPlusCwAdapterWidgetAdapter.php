 ...
 * @Bean
 */
class PayPalPlusCwAdapterWidgetAdapter extends PayPalPlusCwAdapterAbstractAdapter
{
	...
	public function getWidgetTemplateVars() {
		$vars = array(
			'widgetHtml' => $this->getInterfaceAdapter()->getWidgetHtml($this->getTransaction()->getTransactionObject(), Customweb_Util_Encoding::toUTF8($_REQUEST)),
		);
		PayPalPlusCwHelper::getEntityManager()->persist($this->getTransaction());
		return $vars;
	}
