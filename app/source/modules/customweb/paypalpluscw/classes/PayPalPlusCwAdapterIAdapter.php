...
interface PayPalPlusCwAdapterIAdapter {

	public function prepare($order, PayPalPlusCwPaymentMethod $payment, $failedTransaction = null, $transaction = null);

	public function prepareForm($order, PayPalPlusCwPaymentMethod $payment);
