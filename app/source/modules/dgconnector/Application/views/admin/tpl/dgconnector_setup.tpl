             ...
             <dl>
                <dt>
                   ...
                   [{else}]
                      ...
                      <br /><br />composer clearcache<br />
                      vendor/bin/oe-console oe:module:install-configuration source/modules/dgconnector<br />
                      vendor/bin/oe-console oe:module:install-configuration source/modules/[{ $oUpdate->getModul() }]<br />
                      [{/if}]
                   [{/if}]
                  [{/if}]
