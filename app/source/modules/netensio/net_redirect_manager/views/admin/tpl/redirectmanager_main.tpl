...
<table>
    ...
    <tr>
        ...
        <td>
            <input type="text" class="editinput" size="32" maxlength="256" name="editval[netredirectmanager__oxsource]" value="[{$edit->netredirectmanager__oxsource->value}]" [{ $readonly }] [{ $disableSharedEdit }]>
        </td>
    </tr>
    <tr>
        <td class="edittext">[{oxmultilang ident="NET_REDIRECT_MANAGER_MAIN_OXTARGET"}]</td>
        <td>
            <input type="text" class="editinput" size="32" maxlength="256" name="editval[netredirectmanager__oxtarget]" value="[{$edit->netredirectmanager__oxtarget->value}]" [{ $readonly }] [{ $disableSharedEdit }]>
        </td>
    </tr>
    <tr>
