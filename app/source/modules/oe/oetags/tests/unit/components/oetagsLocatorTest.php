...
class Unit_Components_oetagsLocatorTest extends oeTagsTestCase
{
    /**
    ...
    public function testSetListLocatorDataSeo()
    {
        ...
        $oLocator = $this->getMock('testOeTagsLocator', array('getConfig'));
    ...
    public function testSetTagLocatorData()
    {
        ...
        $oTag = $oLocatorTarget->getViewConfig()->getActTag();
        ...
        $this->assertEquals($config->getShopHomeUrl() . "cl=oetagstagcontroller&amp;searchtag=wanduhr&amp;pgNr={$iPgNr}", $oTag->toListLink);
    ...
    public function testLoadIdsInListForPriceCat()
    {
        ...
        $expectedCount = $this->getTestConfig()->getShopEdition() == 'EE'? 44 : 34;
    ...
    public function testGetProductPosMixTypeKeys()
    {
        ...
        $locator = oxNew('testOeTagsLocator');
