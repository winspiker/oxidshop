 ...
 */
class Unit_Controller_Admin_oetagsArticleMainTest extends \oeTagsTestCase
{
    ...
    public function testSave()
    {
        ...
        oxTestModules::addFunction('oetagsarticletaglist', 'save', '{ throw new Exception( "saveTags" ); }');
