...
<p class="desc">
    ...
    Die Fehlermeldung &quot;die Lizenz ist abgelaufen&quot; weist darauf hin, dass die Testlizenz f&uuml;r das Otto Market Anbindung von draufgeschaut.de bereits in Ihrem Shop aktiviert wurde. <br /><br />
...
<div class="messagebox">
 <p>
   ...
   Erweiterungen > Module > Otto Market Anbindung <br /><br />
   Vergessen Sie nicht eventuelle Cronjobs ebenfalls zu deaktivieren.<br />
   <br />
   Danke f&uuml;r Ihr Interresse an unseren Modul Otto Market Anbindung.
 </p>
</div>
