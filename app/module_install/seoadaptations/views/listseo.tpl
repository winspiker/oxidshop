    ...
    <div class="page-header">
        <div class="row">
            <div class="col-md-8">
                ...
                <h1>
                    [{if isset($categoryPrefix)}][{$categoryPrefix}] [{/if}][{$oView->getTitle()}]
            ...
            <div class="col-md-4">
                ...
                [{if !$oView->hasVisibleSubCats() && $oPageNavigation->NrOfPages > 0}]
                [{if is_object($actCategory)}]
                [{include file="widget/header/search.tpl" searchPrefix="_incategory" searchInCategory=$actCategory->getId()}]
                [{/if}]
                [{/if}]
            </div>
        </div>
